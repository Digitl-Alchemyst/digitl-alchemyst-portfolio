   ...
   {/* <div className='mb-50 h-[100vh] bg-gradient-to-r from-primary/10 via-black/30 to-black/10 pt-50 sm:pt-98 md:pb-82 md:pt-120 lg:pb-0 lg:pt-36 xl:pt-24 xxl:pt-8'> */}
          ...
          {/* <div className='h-full w-full'> */}
            {/* <div className='container mx-auto  flex h-full flex-col justify-center pb-10 text-center xl:pt-10 xl:text-left'> */}
              ...
              >
                An accomplished and versatile technology entrepreneur and
                artist, I have honed my skills through self-guided exploration
                and hands-on experience. My deep knowledge spans a wide array of
                ...
                entrepreneurial journey, I have demonstrated the ability to
                adapt to rapidly evolving technologies and leverage them to
                create impactful and visually captivating experiences. Whether
                it&apos;s developing cutting-edge applications or crafting
                ...
                poised to make a significant impact in the ever-evolving
                landscape of technology and art.
              </motion.p>
          ...
          <div className='flex items-center justify-between w-full'>
            ...
            <motion.div
              ...
              className='translate-z-0 absolute h-full max-h-[476px] w-full max-w-[437px] lg:bottom-74 lg:right-[25%]'
              >
              <Profile />
            </motion.div>
              </div>
